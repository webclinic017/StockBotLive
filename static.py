...
def getStockData(stock):
    # print(stock)
    #stock_data = pd.read_csv(f'C:/Users/nirmi/PycharmProjects/StockBotLive/Data/{stock}.txt', parse_dates=True, index_col='Date')[-300:]
    stock_data = pdr.get_data_tiingo(stock, api_key='9d4f4dacda5024f00eb8056b19009f32e58b38e5')[-40:]
